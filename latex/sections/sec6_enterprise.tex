...
\begin{tabular}{@{}clp{3.0cm}p{3.0cm}@{}}
\toprule
\textbf{Level} & \textbf{Name} & \textbf{Characteristics} & \textbf{Diagnostic Criteria} \\
\midrule
L0 & Outcome-Only & Binary pass/fail; black-box accuracy metric only & No trajectory logging; single accuracy figure reported \\
L1 & Pillar-Aware & At least two of four pillars evaluated separately & Tool and model evaluations separated; no cost reporting \\
L2 & Trajectory-Enabled & Execution paths logged and inspected; GPA decomposition applied & Step-level failures diagnosable from traces \\
L3 & Multi-Dimensional & All CLEAR dimensions assessed; CNA reported alongside accuracy & Cost, latency, adherence, and resilience all measured \\
L4 & Adaptive & Continuous, risk-weighted; HITL calibration; evaluation horizon tracked & Scenario manifold with risk weights; judge stress-testing; benchmark refresh cycle in place \\
\bottomrule
\end{tabular}
}
\end{table}
