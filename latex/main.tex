...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{Evaluating the Autonomous Mind}}
\fancyhead[R]{\small\textit{Alchedata}}
\fancyfoot[C]{\thepage}
\renewcommand{\headrulewidth}{0.4pt}

% ── Section Formatting ───────────────────────────────────────────────
\titleformat{\section}{\Large\bfseries\color{alcheblue}}{\thesection}{1em}{}
\titleformat{\subsection}{\large\bfseries\color{alchedark}}{\thesubsection}{1em}{}
\titleformat{\subsubsection}{\normalsize\bfseries\color{alchedark}}{\thesubsubsection}{1em}{}

% ── Custom Commands ──────────────────────────────────────────────────
\newcommand{\keyword}[1]{\textbf{\color{alcheblue}#1}}
\newcommand{\cmark}{\textcolor{safegreen}{\checkmark}}
\newcommand{\xmark}{\textcolor{riskred}{\texttimes}}

% ── Title Page ────────────────────────────────────────────────────────
\title{
    \vspace{-1cm}
    {\Huge\bfseries\color{alcheblue} Evaluating the Autonomous Mind}\\[6pt]
    {\Large\color{alchedark} A Multi-Dimensional Framework for Agentic AI Readiness}\\[18pt]
    {\large A White Paper by Alchedata}\\[6pt]
    {\normalsize Version 1.0 \quad$\cdot$\quad April 2026}
}
...
\begin{abstract}
\noindent
The transition from static large language models to autonomous agentic systems between 2024 and 2026 has exposed a fundamental measurement crisis: evaluation methodologies inherited from traditional NLP fail to capture the non-deterministic, multi-step, tool-mediated nature of agentic behavior. Binary success metrics treat agents as black boxes, measuring where they ended up rather than how they got there---a phenomenon we term the \emph{success masking problem}. This white paper synthesizes emerging research into a comprehensive evaluation framework built on four pillars (Core Model, Memory, Tool Use, and Environment), introduces trajectory-level metrics that evaluate the complete execution path, addresses the Evaluator Paradox through Agent-as-a-Judge paradigms and the Judge Reliability Harness, and proposes the CLEAR framework (Cost, Latency, Efficacy, Adherence, Resilience) as an enterprise readiness standard. We present Cost-Normalized Accuracy (CNA) as a mandatory reporting requirement and survey the open-source tooling landscape that makes these methods practical. The goal: to close the measurement imbalance that currently allows agents to pass benchmarks while failing in production.
\end{abstract}

\vspace{0.5cm}
\noindent\textbf{Keywords:} Agentic AI, evaluation frameworks, trajectory metrics, Agent-as-a-Judge, Cost-Normalized Accuracy, CLEAR framework, enterprise readiness
